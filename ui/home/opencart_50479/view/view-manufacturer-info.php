            ...
            <div class="row">
                <div class="col-sm-9 col-sm-12   " id="content">
                    <div class="breadcrumb">
                        <a href="/home.php">Home</a> » <a href="<?php echo $manufacturer_href; ?>">Thương Hiệu</a> » <a href="<?php echo $manufacturer_name;?>" class="last"><?php echo $manufacturer_name;?></a>
                    </div>
                    ...
                    <div class="product-grid">
                        ...
                        <?php foreach ($manu_products as $product) {?>
                            <li class="<?php if($i%3==0) echo 'first-in-line'; elseif($i%3==2) echo 'last-in-line';$i++;?> col-sm-4">
                                <div class="padding">
                                    <div class="image">
                                        <a href="<?php echo $product['product_href'];?>"><img id="img_<?php echo $product['product_id'];?>" src="<?php echo $product['thumb'];?>" title="<?php echo $product['name'];?>" alt="<?php echo $product['name'];?>">
                                        </a>
                                    </div>
                                    <div class="left">
                                        ...
                                        <div class="cart-button">
                                            <div class="cart">
                                                <a onclick="cart.add('<?php echo $product['product_id'];?>');" class="button" title="Add to Cart"> <span>Thêm vào giỏ</span>
                                                </a>
                                            </div>
                    ...
                    <div class="pagination">
                        <!-- 
                        <div class="links"> <b>1</b> <a href="https://livedemo00.template-help.com/opencart_50479/index.php?route=product/manufacturer/info&amp;manufacturer_id=8&amp;page=2">2</a> <a href="https://livedemo00.template-help.com/opencart_50479/index.php?route=product/manufacturer/info&amp;manufacturer_id=8&amp;page=2">&gt;</a> <a href="https://livedemo00.template-help.com/opencart_50479/index.php?route=product/manufacturer/info&amp;manufacturer_id=8&amp;page=2">&gt;|</a> </div>
                        <div class="results">Showing 1 to 6 of 7 (2 Pages)</div>
                         -->
