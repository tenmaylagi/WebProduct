<DIV id="container">
                            ...
                            <DIV class="camera_container">
                                <DIV id="camera_wrap_0">
                                   <?php foreach (banner_imageActives() as $banner) { ?>
	                                ...
	                                <DIV title="slide-1" data-src="<?php echo $banner['image']; ?>" data-thumb="<?php echo $banner['image']; ?>">
                        ...
                        <DIV class="banners row" id="banner0">
	                        ...
	                        <DIV class="box featured">
	                            ...
	                            <DIV class="box-content">
	                                <DIV class="row ">
	                                    <!-- foreach start -->
	                        			<?php foreach(productFeatureds() as $product ) { //mở for ?>            
	...
	title="<?php echo $product['name'] ?>" class="img-responsive" alt="<?php echo $product['name'] ?>" 
	...
	class="fa fa-star-o fa-stack-2x"></I></SPAN> </DIV>
	                                            ...
	                                            <DIV class="image">
	                                                <A class="lazy" style="padding-bottom: 77.27%;" href="<?php echo $product['href'];?>"><IMG 
	title="<?php echo $product['name'] ?>" class="img-responsive" alt="<?php echo $product['name'] ?>" 
	src="<?php echo $product['thumb'];?>" data-src="<?php echo $product['thumb'];?>"></A>
	                                            </DIV>
	                                            <DIV class="caption">
	                                                <DIV class="price"><?php echo $product['price'];?></DIV>
	                                                <DIV class="name">
                            ...
                            <DIV class="row">
                                <DIV class="col-sm-4">
                                    <DIV class="box-bg">
                                        ...
                                        <A class="btn btn-home" href="#">Chi tiết... </A> </DIV>
                                </DIV>
                                <DIV class="col-sm-4">
                                    <DIV class="box-bg">
                                        <H4>Miễn Phí Ship</H4>
