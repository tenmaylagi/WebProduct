      ...
      <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="address">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="company" value="" placeholder="Công ty" id="input-company" class="form-control" type="text">
            </div>
          </div>
          -->
          <div class="form-group required">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="postcode" value="<?php echo $postcode; ?>" placeholder="Mã bưu điện" id="input-postcode" class="form-control" type="text">
                          </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-zone">Vùng miền</label>
            <div class="col-sm-10">
              <select name="zone_id" id="input-zone" class="form-control">
              	<option value=""> --- Hãy chọn --- </option>
              	<?php foreach(zoneGetAll() as $zone) {?>
                <option value="<?php echo $zone['zone_id'];?>" <?php if((int)$zone['zone_id'] == (int)$zone_id) echo 'selected';?>><?php echo $zone['name'];?></option>
              	<?php }?>
              </select>
            </div>
          </div>
