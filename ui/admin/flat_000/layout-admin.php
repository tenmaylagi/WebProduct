...
<html lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<!-- ================== BEGIN BASE JS ================== -->
	<script async src="/ui/admin/flat_000/template_files/analytics.js"></script><script src="/ui/admin/flat_000/template_files/pace.min.js"></script>
	<!-- ================== END BASE JS ================== -->
</head>
			...
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
					 ...
					 -->
					<li>
						<a href="/home.php" title="Trang Chủ" target="_blank"><i class="fa fa-home"></i></a>
					</li>
					<!-- 
					<li class="dropdown">
