...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/ui/admin/flat_006/layout-admin_files/style.css">
    <link rel="stylesheet" type="text/css" href="/ui/admin/flat_006/layout-admin_files/nanoscroller.css"><!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="/ui/admin/flat_006/layout-admin_files/theme-switcher.min.css">
    <link rel="stylesheet" type="text/css" href="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-1.2.2.css"><link type="text/css" href="/ui/admin/flat_006/layout-admin_files/style(1).css" rel="stylesheet">  <style type="text/css">.jqstooltip { position: absolute;left: 0px;top: 0px;visibility: hidden;background: rgb(0, 0, 0) transparent;background-color: rgba(0,0,0,0.6);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000);-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000)";color: white;font: 10px arial, san serif;text-align: left;white-space: nowrap;padding: 5px;border: 1px solid white;box-sizing: content-box;z-index: 10000;}.jqsfield { color: white;font: 10px arial, san serif;text-align: left;}</style></head>
  <body style="">
    <div class="am-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div id="am-navbar-collapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right am-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="<?php echo user_image();?>"><span class="user-name"><?php echo user_fullname();?></span><span class="angle-down s7-angle-down"></span></a>
            ...
            <ul class="nav navbar-nav am-nav-right">
              ...
              <li><a href="/admin-logout.php">Đăng Thoát &nbsp;<i class="fa fa-sign-out fa-lg"></i></a></li>
              <!--
                        ...
                        <div class="content nano-content" tabindex="0" style="right: -17px;">
                          <ul>
                            <li class="active"><a href="#">
                                <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/avatar2.jpg"></div>
                            ...
                            <li><a href="#">
                                <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/avatar3.jpg"></div>
                            ...
                            <li><a href="#">
                                <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/avatar4.jpg"></div>
                            ...
                            <li><a href="#">
                                <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/avatar5.jpg"></div>
                  ...
                  <li>
                    ...
                    <div class="list">
                      <div class="content">
                        <ul>
                          <li>
                            <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/github.png"></div>
                          ...
                          <li>
                            <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/bitbucket.png"></div>
                          ...
                          <li>
                            <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/slack.png"></div>
                          ...
                          <li>
                            <div class="logo"><img src="/ui/admin/flat_006/layout-admin_files/dribbble.png"></div>
      ...
      <div class="am-left-sidebar">
        <div class="content">
          ...
          <!-- <i class="icon s7-map-marker"></i> , <i class="icon s7-diamond"></i> , <i class="icon s7-mail"></i> <i class="icon s7-ribbon"></i>
          <i class="icon s7-graph"></i>
          http://themes-pixeden.com/font-demos/7-stroke/
          -->
          <!--
            <li class="parent active open"><a href="/admin/dashboard.php"><i class="icon s7-monitor"></i><span>Dashboard</span></a>
              
            </li>
            -->
            <li class="parent"><a href="/admin/order.php"><i class="icon s7-cart"></i><span>Đơn Hàng</span></a>
            <li class="parent"><a href="/admin/customer.php"><i class="icon s7-users"></i><span>Khách Hàng</span></a>
            
            <li class="parent"><a href="/admin/category.php"><i class="icon s7-ticket"></i><span>Loại Sản Phẩm</span></a>
            <li class="parent"><a href="/admin/product.php"><i class="icon s7-diamond"></i><span>Sản Phẩm</span></a>
            <li class="parent"><a href="/admin/manufacturer.php"><i class="icon s7-note2"></i><span>Nhà Sản Xuất</span></a>
            </li>
            <li class="parent"><a href="#"><i class="icon s7-settings"></i><span>Hệ Thống</span></a>
              ...
              <ul>
			      ...
			      <li><a href="/admin/banner-image.php"></i><span>Ảnh Banners</span></a>
			      </li>
            ...
            <div class="tab-content">
              ...
              <div id="tab2" role="tabpanel" class="tab-pane chat">
                  ...
                  <div class="chat-sections">
                    <div class="am-scroller nano has-scrollbar">
                      <div class="content nano-content" tabindex="0" style="right: -17px;">
                        <h2>Recent</h2>
                        <div class="recent">
                          <div class="user"><a href="#"><img src="/ui/admin/flat_006/layout-admin_files/avatar4.jpg">
                              <div class="user-data"><span class="status away"></span><span class="name">Claire Sassu</span><span class="message">Can you share the...</span></div></a></div>
                          <div class="user"><a href="#"><img src="/ui/admin/flat_006/layout-admin_files/avatar7.jpg">
                              <div class="user-data"><span class="status"></span><span class="name">Maggie jackson</span><span class="message">I confirmed the info.</span></div></a></div>
                          <div class="user"><a href="#"><img src="/ui/admin/flat_006/layout-admin_files/avatar3.jpg">
                              <div class="user-data"><span class="status offline"></span><span class="name">Joel King		</span><span class="message">Ready for the meeti...</span></div></a></div>
                        </div>
                        <h2>Contacts</h2>
                        <div class="contact">
                          <div class="user"><a href="#"><img src="/ui/admin/flat_006/layout-admin_files/avatar6.jpg">
                              <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div></a></div>
                          <div class="user"><a href="#"><img src="/ui/admin/flat_006/layout-admin_files/avatar7.jpg">
                              <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div></a></div>
                          <div class="user"><a href="#"><img src="/ui/admin/flat_006/layout-admin_files/avatar8.jpg">
                ...
                <div class="chat-window">
                  <div class="title">
                    <div class="user"><img src="/ui/admin/flat_006/layout-admin_files/avatar7.jpg">
    ...
    <script async="" src="/ui/admin/flat_006/layout-admin_files/analytics.js"></script><script src="/ui/admin/flat_006/layout-admin_files/jquery.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery.nanoscroller.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/main.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/bootstrap.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/theme-switcher.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery.flot.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery.flot.pie.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery.flot.resize.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery.flot.orderBars.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/curvedLines.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery.sparkline.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-ui.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-us-merc-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-uk-mill-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-fr-merc-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-us-il-chicago-mill-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-au-mill-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-in-mill-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-map.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/jquery-jvectormap-ca-lcc-en.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/countUp.min.js" type="text/javascript"></script>
    <script src="/ui/admin/flat_006/layout-admin_files/Chart.min.js" type="text/javascript"></script>
