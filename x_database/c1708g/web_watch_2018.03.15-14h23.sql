CREATE DATABASE  IF NOT EXISTS `web_watch` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `web_watch`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win32 (AMD64)
--
-- Host: 127.0.0.1    Database: web_watch
-- ------------------------------------------------------
...
-- Dump completed on 2018-03-15 14:23:23
